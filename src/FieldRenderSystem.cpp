...
namespace lve {
    ...
    FieldRenderSystem::FieldRenderSystem(
        LveDevice& device,
    ...
    void FieldRenderSystem::createPipelineLayout() {
    ...
    void FieldRenderSystem::createPipeline(VkRenderPass render_pass) {
    ...
    void FieldRenderSystem::renderGameObjects(VkCommandBuffer command_buffer, std::vector<LveGameObject>& game_objects) {
